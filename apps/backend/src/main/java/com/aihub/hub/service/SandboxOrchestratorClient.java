...
public class SandboxOrchestratorClient {
    ...
    public SandboxOrchestratorJobResponse createJob(SandboxJobRequest request) {
        ...
        Optional.ofNullable(request.reasoningEffort()).ifPresent(value -> body.put("reasoningEffort", value));
    ...
    public record SandboxOrchestratorJobResponse(
        ...
        Long maxModelReasoningWaitMs,
        Long maxCommandExecutionWaitMs,
        Long maxExternalServiceWaitMs,
        ...
        public static SandboxOrchestratorJobResponse from(JsonNode node) {
            ...
            return new SandboxOrchestratorJobResponse(
                ...
                readText(node, "reasoningSummary", "reasoning_summary"),
                ...
                readLong(node, "maxModelReasoningWaitMs", "max_model_reasoning_wait_ms"),
                readLong(node, "maxCommandExecutionWaitMs", "max_command_execution_wait_ms"),
                readLong(node, "maxExternalServiceWaitMs", "max_external_service_wait_ms"),
                interactions,
                httpRequests,
                documentAccesses,
