...
- O AWS CLI vem pré-instalado para permitir que o modelo execute verificações e operações AWS quando o ambiente fornecer credenciais e permissões adequadas.
